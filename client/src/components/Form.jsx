      ...
      <div className="min-h-screen md:flex">
        ...
        <div className="min-h-screen md:w-1/2 bg-custom-pokeB flex flex-col">
          ...
          <div className="md:h-3/4 bg-custom-pokeB">
            <div class="container max-w-md mx-auto xl:max-w-4xl flex rounded-lg overflow-hidden m-30 flex-grow justify-center">
              <div class="md:w-2/4 md:p-20  p-3">
                <form method="post" action="#" onSubmit={handleSubmit}>
                  ...
                  <div class="mb-6 flex items-center justify-between">
                    <div class="m-2 mb-[0.125rem] block min-h-[1.5rem] pl-[1.5rem]">
                      <input
                  ...
                  <button class="bg-blue-900 mb-3 no-underline flex w-full items-center justify-center rounded  px-7 pb-2.5 pt-3 text-center text-sm font-medium uppercase leading-normal text-white ">
                    <svg
                  ...
                  <button class="bg-blue-400 mb-3 no-underline flex w-full items-center justify-center rounded  px-7 pb-2.5 pt-3 text-center text-sm font-medium uppercase leading-normal text-white ">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      class="mr-2 h-3.5 w-3.5"
                      fill="currentColor"
