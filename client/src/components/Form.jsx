...
const Form = function () {
  return (
    ...
    <div class="relative mb-6  border-white border" data-te-input-wrapper-init>
            <input
              type="text"
          ...
          <button
            class="bg-blue-900 mb-3 no-underline flex w-full items-center justify-center rounded  px-7 pb-2.5 pt-3 text-center text-sm font-medium uppercase leading-normal text-white "
          ...
          <button
            class="bg-blue-400 mb-3 no-underline flex w-full items-center justify-center rounded  px-7 pb-2.5 pt-3 text-center text-sm font-medium uppercase leading-normal text-white "
