...
function Arena() {
  ...
  return (
    <div className="h-full bg-townYN bg-cover flex flex-col items-center justify-center">
          ...
          <div className="flex flex-col mx-5 px-5 m-10">
            ...
            >
              <p className="text-white flex-1 w-2/3 font-bold text-xl m-3">
                {" "}
                You vs{" "}
                {usersName.length > 0 ? usersName[0] : "No in-progress battles"}
              </p>
            </div>
            <div
            ...
            >
              <p className="text-red-500 font-bold text-xl m-3">
                {" "}
                You vs{" "}
                {usersName.length > 1 ? usersName[1] : "No in-progress battles"}
              </p>
            </div>
            <div
              ...
              onClick={() => {
                ...
                console.log("testtime" + time[2]);
              }}
            >
              <p className="text-black font-bold text-xl m-3">
                {" "}
                You vs{" "}
                {usersName.length > 2 ? usersName[2] : "No in-progress battles"}
              </p>
            </div>
          </div>
        </div>
